...
# move ipa to jenkins dest directory
timestamp=`date "+%Y%m%d%H%M"`

echo ${JENKINS_APPBUILD_PATH}
echo ${JENKINS_HOME}
echo ${JOB_NAME}

mv bin/${PROJECT_NAME}.ipa ${JENKINS_APPBUILD_PATH}/${APP_NAME}_${timestamp}.ipa || failed "mv ipa"

#cp ipa to dest directory

cp ${JENKINS_APPBUILD_PATH}/${APP_NAME}_${timestamp}.ipa ${APP_DIR}/${APP_NAME}_${timestamp}.ipa || failed "cp ipa"
